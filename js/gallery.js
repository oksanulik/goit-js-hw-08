...
addElements.insertAdjacentHTML("beforeend", markup);
console.log(addElements);

addElements.addEventListener("click", imageClick);
...
function imageClick(event) {
  ...
  const bigImageBig = event.target.dataset.source;
  console.log(bigImageBig);

  const instance = basicLightbox.create(`
    <img src="${bigImageBig}" width="800" height="600">
`);
